...
object BinarySearchSTTest : Spek({
    Feature("1. a binary search symbol table") {
        val searchST by memoized { BinarySearchST<String, Int>() }
        Scenario("putting some values") {
            ...
            Then("should be equal to the test values") {
                assertEquals(listOf("hello", "hey", "world"), searchST.keys())
                assertEquals(listOf("world"), searchST.keys("hez", "world"))
                assertEquals(4, searchST.get("hello"))
                assertEquals(null, searchST.get("hell"))
                assertEquals(true, searchST.contains("hey"))
                assertEquals(false, searchST.contains("he"))
                assertEquals(false, searchST.isEmpty())
    ...
    Feature("2. a binary search symbol table") {
        val searchST by memoized { BinarySearchST<String, Int>() }
